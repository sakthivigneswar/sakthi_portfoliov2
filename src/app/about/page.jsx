      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            {/* BIOGRAPHY IMAGE */}
            <Image
              src="https://files.catbox.moe/dh4olc.jpeg"
              alt=""
              width={112}
              height={112}
            ...
            <h1 className="font-bold text-2xl">Memoir</h1>
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
            Programming is my passion, reflected in my fluency across classic languages like C, C++, JavaScript, and Python, with a specific focus on web development and machine learning applications
            </p>
            {/* BIOGRAPHY QUOTE */}
            <span className="italic">
            Welcome to my world of underwhelming accomplishments. Dont worry, the disappointment is free of charge
            </span>
            {/* BIOGRAPHY SIGN SVG*/}
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="p-1 rounded bg-white text-sm font-semibold w-fit">
                   Bharathidaasan Matric Higher Secondary School  
                  </div>
                </div>
                {/* CENTER */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    I completed my Bachelor degree in Computer Science and well in computing languages like C, C++,HTML,CSS,Javascript,Python, SQL
                    .{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
